...
def get_args_parser():
    ...
    parser.add_argument('--camera', action='store_true', help='Use webcam instead of input image')
...
def main(args):
    ...
    if True:
        ...
        while True:
            ...
            image, orig_image_size = preprocess_frame(frame)
